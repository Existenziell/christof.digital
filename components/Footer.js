      ...
      {router.pathname !== '/' &&
        <Link href='/'>
          <a className='absolute left-0' aria-label='Back Home'>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 hover:text-brand transition-colors cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
