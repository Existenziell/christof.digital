...
const Curriculum = () => {
  ...
  return (
    <div className="pb-16 bg-cloth-pattern bg-repeat dark:bg-cloth-pattern-dark dark:text-gray-300">
      ...
      <div className='w-full shadow hover:shadow-md p-8 bg-white text-sm text-left mb-8 dark:bg-black dark:text-gray-300'>
      ...
      <div className='w-full shadow hover:shadow-md p-8 bg-white text-sm text-left dark:bg-black dark:text-gray-300'>
