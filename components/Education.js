  ...
  return (
    <>
      ...
      {education.map(e => {
        ...
        return (
          <div key={title} className='w-full shadow rounded p-8 text-sm text-left mb-8 lg:w-2/3 lg:mx-auto bg-gradient-to-b from-brand-dark to-brand dark:bg-gradient-to-t text-gray-200 dark:bg-black dark:text-gray-300'>
