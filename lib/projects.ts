...
export const projects: Project[] = [
  ...
  { name: 'JavaScript Playground', desc: 'A playground for algorithmic fun with JavaScript. And a tool for sharing code solutions for interviews.', tech: ['Algorithms', 'React', 'Code interviews'], image: 'playground.webp', link: '/software-engineer/playground', external: false },
  ...
  { name: 'Video Recording', desc: 'Building my own video recording app using MediaCapture and the Streams API.', tech: ['MediaCapture', 'HTML5', 'Streams API'], image: 'recording.webp', link: '/software-engineer/projects/recording', external: false },
