  ...
  return (
    <div className="items-center justify-content text-left w-full">
      ...
      <p className='mt-8 md:w-1/2'>
        ...
        Having worked mostly in the backend for years (PHP, Ruby on Rails, Java, nodeJS, ...) I later went Fullstack into JavaScript and nowadays this distinction is rarely made any more.
