        ...
        <div className='w-full text-center'>
          ...
          <ul className='flex flex-col space-y-8 justify-center items-start text-left w-full lg:mx-auto mt-2'>
            {data.map((job, index) => {
              ...
              return (
                <li key={index} className='card card--large w-full px-4 sm:px-8 pt-12 pb-8 relative text-sm dark:text-gray'>
                  ...
                  <p dangerouslySetInnerHTML={{ __html: desc }} className='text-base my-4 bg-gray-dark/10 dark:bg-gray/10 dark:text-gray rounded-sm px-6 py-4 max-w-full' />
