export const projects = [
  ...
  },
  {
    ...
    desc: "A playground for algorithmic fun with React. And a tool for sharing code solutions for interviews.",
    tech: ['Algorithms', 'React', 'Code interviews'],
    image: "playground.webp",
    link: "https://react-app-playground.vercel.app/",
    external: true,
  },
  {
    name: "CZMStem Clinic",
  ...
  },
  {
    ...
    desc: "Building my own video recording app using MediaCapture and the Streams API.",
    tech: ['MediaCapture', 'HTML5', 'Streams API'],
